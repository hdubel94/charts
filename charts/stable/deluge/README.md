...
|------------|------|---------|
| https://library-charts.hdubel94.com | common | 4.5.2 |
...
helm repo update
helm install deluge hdubel94/deluge
```
...
```console
helm install deluge hdubel94/deluge -f values.yaml
```
...
A historical overview of changes can be found on [ArtifactHUB](https://artifacthub.io/packages/helm/hdubel94/deluge?modal=changelog)
